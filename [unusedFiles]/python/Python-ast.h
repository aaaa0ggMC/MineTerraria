...
stmt_ty _Py_FunctionDef(identifier name, arguments_ty args, asdl_seq * body,
                        asdl_seq * decorator_list, expr_ty returns, pystring
...
stmt_ty _Py_AsyncFunctionDef(identifier name, arguments_ty args, asdl_seq *
                             ...
                             pystring type_comment, int lineno, int col_offset,
...
stmt_ty _Py_Assign(asdl_seq * targets, expr_ty value, pystring type_comment, int
...
stmt_ty _Py_For(expr_ty target, expr_ty iter, asdl_seq * body, asdl_seq *
                orelse, pystring type_comment, int lineno, int col_offset, int
                end_lineno, int end_col_offset, PyArena *arena);
...
stmt_ty _Py_AsyncFor(expr_ty target, expr_ty iter, asdl_seq * body, asdl_seq *
                     orelse, pystring type_comment, int lineno, int col_offset,
...
stmt_ty _Py_With(asdl_seq * items, asdl_seq * body, pystring type_comment, int
                 lineno, int col_offset, int end_lineno, int end_col_offset,
                 PyArena *arena);
#define AsyncWith(a0, a1, a2, a3, a4, a5, a6, a7) _Py_AsyncWith(a0, a1, a2, a3, a4, a5, a6, a7)
stmt_ty _Py_AsyncWith(asdl_seq * items, asdl_seq * body, pystring type_comment,
...
expr_ty _Py_Constant(constant value, pystring kind, int lineno, int col_offset,
                     int end_lineno, int end_col_offset, PyArena *arena);
...
arg_ty _Py_arg(identifier arg, expr_ty annotation, pystring type_comment, int
               lineno, int col_offset, int end_lineno, int end_col_offset,
               PyArena *arena);
...
type_ignore_ty _Py_TypeIgnore(int lineno, pystring tag, PyArena *arena);
